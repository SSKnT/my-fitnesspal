    ...
    return(
        <section className=" dark:bg-gray-900  my-4 lg:my-0">
          <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
            ...
            <main
              className="flex items-center justify-center sm:px-0 lg:col-span-7 lg:px-8 lg:py-6 xl:col-span-8"
            >
              <div className="max-w-xl lg:max-w-3xl rounded-tr-3xl rounded-bl-3xl p-8 bg-gray-500 bg-opacity-10 ">
                ...
                <h1 className="mt-6 text-2xl font-bold text-gray-200 sm:text-3xl md:text-4xl dark:text-white">
                  Profile 🦑
                </h1>

                <p className="mt-4 leading-relaxed text-[#b3b3b3] dark:text-gray-400">
                ...
                <form action="#" className="mt-8 grid grid-cols-6 gap-6">
                  ...
                  <div className="col-span-6">
                    <label htmlFor="Email" className="block text-sm font-medium   text-gray-500 dark:text-gray-200">
                      Email
                    </label>
...
const Img = () => {
    return(
        <aside className="relative hidden lg:block h-16 lg:order-last lg:col-span-5 lg:h-full xl:col-span-4">
          <img
            alt=""
            src="https://images.unsplash.com/photo-1498036882173-b41c28a8ba34?q=80&w=1528&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
